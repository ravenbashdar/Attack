...
do
    ...
    echo " "
    echo   😈Arez Bashdar : System Zone😈
    echo "Press 1 To  Start Nama nard "
    echo "Press 2 To  Start Talafon Krdn "
    echo "Press 3 To  Update krdny Tool "
    echo "Press 4 To  Darawa "
    read ch
    clear
    if [ $ch -eq 1 ];then
        $PYTHON Ab-B.py --sms
